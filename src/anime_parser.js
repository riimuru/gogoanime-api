...
const anime_info_url = 'https://anitaku.to/';
...
const Referer = 'https://anitaku.to/';
const goload_stream_url = 'https://goload.io/streaming.php';
export const DownloadReferer = 'https://anitaku.to/';
